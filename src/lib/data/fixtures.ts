...
export const FIXTURE_DEBATES: DebateDetail[] = [
  ...
  },
  {
    ...
    description_ar:
      "تقدّر كلفة إعادة الإعمار بعشرات المليارات، ومصدر التمويل يحدّد إلى حدّ بعيد من يرسم الأولويات. ناقش الضيفان خيارات التمويل وشروطها، ودور القطاع الخاص، وآليات الشفافية في العقود العامة، والموازنة بين الإغاثة العاجلة والاستثمار طويل الأمد.",
    status: "completed",
  ...
  },
  {
    ...
    description_ar:
      "المناهج الدراسية ليست مسألة تربوية فقط، بل سؤال عن السردية الوطنية والذاكرة المشتركة. تناولت الندوة حدود التوحيد، ومساحة التنوّع المحلي، وتدريس التاريخ القريب، ودور المعلّم.",
    status: "completed",
  ...
  },
  {
    ...
    description_ar:
      "بحثت الندوة في نماذج الإعلام العام حول العالم، وشروط استقلاليته، وآليات تمويله وحوكمته، والفرق بين إعلام الدولة وإعلام الخدمة العامة.",
    status: "archived",
